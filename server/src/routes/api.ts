...
export function createApiRouter(
  ...
  router.get('/interests', (_req: Request, res: Response) => {
    res.json({ interests: CURATED_INTERESTS });
  });

  router.get('/starters', (_req: Request, res: Response) => {
   ...
   */
  router.post('/identity/generate', (req: Request, res: Response) => {
    ...
    const recommendations = CURATED_INTERESTS.filter((i: string) => !lowerInterests.includes(i.toLowerCase())).slice(0, 4);
   ...
   */
  router.post('/users/register-anonymous', (req: Request, res: Response) => {
  ...
  router.get('/rooms/:codeOrId', (req: Request, res: Response) => {
